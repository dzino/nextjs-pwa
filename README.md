...
В левом верхнем углу вкладки браузера Вы увидите кнопку установки.

Теперь, если вы нажмете «Установить», приложение будет установлено и появится всплывающее окно.
